...
def main():
    ...
    weekly_ride_diffs = (
        bike_rides_per_day.with_columns(
    ...
    df_biker_rides_per_day = bike_rides_per_day.collect()
    df_weekly_stats = weekly_stats.collect()
    df_weekly_ride_diffs = weekly_ride_diffs.collect()
    for df in [df_biker_rides_per_day, df_weekly_stats, df_weekly_ride_diffs]:
        print(df.head())
